/* Flappy Nexus for the web: the same game as in the NexusHub app (same physics, same look). */
(function () {
  ...
  class Game {
    ...
    step(dt) {
      ...
      if (this.hit()) {
        ...
        if (this.score > this.best && this.hud) {
    ...
    hud(ctx, worldW) {
      ...
      if (this.state === "ready") this.panel(ctx, worldW, "Flappy Nexus", ["Click, tap or Space to flap", `Best: ${this.best}`], null, 0.24);
